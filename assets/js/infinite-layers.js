...
export default class Index {
  constructor() {
    ...
    this.sources = [
      {src: 'assets/images/featured/1.jpg', caption: ''},
      {src: 'assets/images/featured/2.jpg', caption: ''},
      {src: 'assets/images/featured/3.jpg', caption: ''},
      {src: 'assets/images/featured/4.jpg', caption: ''},
      {src: 'assets/images/featured/5.jpg', caption: ''},
      {src: 'assets/images/featured/6.jpg', caption: ''},
